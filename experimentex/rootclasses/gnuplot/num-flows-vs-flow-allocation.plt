...
# Line styles
set style line 1 lt rgb "#2177b0" lw 4 pt 6 ps 1.4
...
# Axes labels
set xlabel "[X-LABEL]" # Markup: e.g. 99^{th}, {/Symbol s}, {/Helvetica-Italic P}
set ylabel "[Y-LABEL]"
...
plot    "[DATA-FILE]" using ($1):($2) title "" w lp ls 1, \
